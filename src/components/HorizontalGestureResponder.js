...
import { isValidHorizontalGesture } from '../util/gesture/index';

class HorizontalGestureResponder extends React.Component {
...
HorizontalGestureResponder.propTypes = {
...
HorizontalGestureResponder.defaultProps = {
    enabled: true,
